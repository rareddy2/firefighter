...
echo_and_run cd "/home/ur3/catkin_firefighter/src/lab2andDriver/drivers/camera_calibration/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ur3/catkin_firefighter/src/lab2andDriver/drivers/camera_calibration/image_pipeline/camera_calibration/setup.py" \
     \
    build --build-base "/home/ur3/catkin_firefighter/build/lab2andDriver/drivers/camera_calibration/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
