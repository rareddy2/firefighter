...
echo_and_run cd "/home/ur3/catkin_firefighter/src/lab2andDriver/drivers/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ur3/catkin_firefighter/src/lab2andDriver/drivers/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/ur3/catkin_firefighter/build/lab2andDriver/drivers/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
