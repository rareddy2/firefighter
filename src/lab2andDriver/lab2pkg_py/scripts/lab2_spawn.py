...
def spawn_block(config_idx, missing_block=False):
    ...
    lab5_path = rospack.get_path('lab2pkg_py')
    ...
    block_yellow_position = positions_dict['ice_positions'][config_idx]

    block_green_position = positions_dict['fire_positions'][config_idx]
